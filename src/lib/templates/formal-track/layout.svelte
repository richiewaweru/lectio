...
<!--
  formal-track — print-first, no sidebar, no visual ornament.
  Pedagogical arc: hook (optional) → definition → explanation → key fact →
                   worked example → pitfall → practice → close.
-->
