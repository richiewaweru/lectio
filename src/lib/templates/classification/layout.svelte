...
<!--
  classification — comparison grid is the spine; everything else frames it.
  Pedagogical arc: hook → callout → explanation → definition family →
                   comparison grid → insight strip → pitfall → practice → close.
-->
